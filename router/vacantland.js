...
router.get('/fetchdatafilter', async (req, res) => {
	//res.setHeader('Access-Control-Allow-Origin', '*');
	const response = await vancantController.fetchdatafilter(req.query.Facing,req.query.DTCP,req.query.RegisterOffice,req.query.Sold,req.query.MainRoadFacing,req.query.Refertype);
	res.send(response);
})
